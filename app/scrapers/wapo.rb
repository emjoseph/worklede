...
def scrape_jobs_for_section(url, section_name, company, platform, browser)
  ...
  page.css('.WL2F').each_with_index do |posting, index|

      title = posting.css('.WM4O')[0].text
      puts title

      subheader = posting.css('span.WI2F').text
      puts subheader
      ...
      job_url = "https://washpost.wd5.myworkdayjobs.com#{itemUrls[index]}"
...
jobs_section_urls = [
  ["https://washpost.wd5.myworkdayjobs.com/washingtonpostcareers/jobs", "Job Openings", "The Washington Post", "Workday"]
]
