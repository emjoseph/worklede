Given("that I am logged in and on my profile page and planning to upload a resume") do
  user = User.new
...
When("I push the submit button to upload a resume with a name entered and a file chosen") do
...
Then("I'll see receive an email saying the resume was successfully uploaded") do
  open_email("joseph.eugene@gmail.com")
  puts current_email
  puts current_email.subject
  expect(current_email.subject).to eq "WorkLede: New Resume Uploaded"
end
